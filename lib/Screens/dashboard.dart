  ...
  Widget build(BuildContext context) {
    return Consumer<DashboardProvider>(builder: (context, value, child) {
      return FutureBuilder(
          future: value.getDashboardDetails(),
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            ...List.generate(
                                dashboardData
                                        ?.result?.dashboardCalender?.length ??
                                    0,
                                ((i) => DayWidget(
                                    dashboardCalender: dashboardData!
                                        .result!.dashboardCalender![i])))
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Padding(
                            ...
                            child: Image.network(
                              dashboardData!
                                  .result!.bannerList![index].bannerPhoto!,
                              fit: BoxFit.cover,
                            ),
                          );
                        },
                     ...
                     Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            "View all",
                            style: TextStyle(fontWeight: FontWeight.w400, fontSize: 16, color: Theme.of(context).primaryColor),
                          ),
                          Icon(Icons.navigate_next_outlined, color: Theme.of(context).primaryColor)
                        ],
                      ),
                    ),
                    SizedBox(
                      ...
                      child: ListView(
                          ...
                          children: [
                            ...List.generate(
                                dashboardData
                                        ?.result?.sallerProductList?.length ??
                                    0, (int ind) {
                              return BestSellerWidget(
                                sallerProductList: dashboardData!
                                    .result!.sallerProductList![ind],
                              );
                            }),
                            Container(
                              height: 200,
                              ...
                              color: Colors.white,
                              child:
                                  const Center(child: Text("View All product")),
                            )
                          ]),
                    ),
                    Container(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  dashboardData
                                          ?.result?.referEarnText?.titleText ??
                                      '',
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20),
